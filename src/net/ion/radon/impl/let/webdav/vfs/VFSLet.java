package net.ion.radon.impl.let.webdav.vfs;
...
public class VFSLet extends AbstractLet {
	...
	private VFile getVirtualFile() throws FileSystemException {
		FileSystemEntry fe = getContext().getAttributeObject(FileSystemEntry.class.getCanonicalName(), FileSystemEntry.class);
