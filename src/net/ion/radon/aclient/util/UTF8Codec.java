...
public class UTF8Codec {
	 ...
	 * 
	 * private final static Charset utf8; static { utf8 = Charset.forName("UTF-8"); }
	 * 
	 * public static byte[] toUTF8(String input) { return input.getBytes(utf8); }
	 * 
	 * public static String fromUTF8(byte[] input) { return fromUTF8(input, 0, input.length); }
	 * 
	 * public static String fromUTF8(byte[] input, int offset, int len) { return new String(input, offset, len, utf8); }
	 */
