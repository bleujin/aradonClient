...
import net.ion.radon.client.AsyncCompletionHandler;
import net.ion.radon.client.AsyncHttpClient;
import net.ion.radon.client.AsyncHttpClientConfig;
import net.ion.radon.client.AsyncHttpClientConfigBean;
import net.ion.radon.client.AsyncHttpProviderConfig;
import net.ion.radon.client.Cookie;
import net.ion.radon.client.FluentCaseInsensitiveStringsMap;
import net.ion.radon.client.MaxRedirectException;
import net.ion.radon.client.Part;
...
import net.ion.radon.client.StringPart;
import net.ion.radon.client.AsyncHttpClientConfig.Builder;
...
public abstract class AsyncProvidersBasicTest extends AbstractBasicTest {
	...
	public void asyncStatusHEADContentLenghtTest() throws Throwable {
		...
		if (!latch.await(10 * 5 * 1000, TimeUnit.SECONDS)) {
			Assert.fail("Timeout out");
		}
		n.close();
