...
import net.ion.radon.client.ByteArrayPart;
import net.ion.radon.client.Response;
import net.ion.radon.client.SimpleAsyncHttpClient;
import net.ion.radon.client.consumers.AppendableBodyConsumer;
import net.ion.radon.client.consumers.OutputStreamBodyConsumer;
import net.ion.radon.client.generators.FileBodyGenerator;
import net.ion.radon.client.generators.InputStreamBodyGenerator;
import net.ion.radon.client.simple.HeaderMap;
import net.ion.radon.client.simple.SimpleAHCTransferListener;
...
public abstract class SimpleAsyncHttpClientTest extends AbstractBasicTest {
	...
	public void testPutZeroBytesFileTest() throws Throwable {
		...
		SimpleAsyncHttpClient client = new SimpleAsyncHttpClient.Builder().setIdleConnectionInPoolTimeoutInMs(100).setMaximumConnectionsTotal(50).setRequestTimeoutInMs(5 * 1000).setUrl(getTargetUrl() + "/testPutZeroBytesFileTest.txt").setHeader("Content-Type", "text/plain").build();
