 ...
 */
package net.ion.radon.client.websocket;
...
import net.ion.radon.client.websocket.TextMessageTest;
import net.ion.radon.client.websocket.WebSocket;
import net.ion.radon.client.websocket.WebSocketCloseCodeReasonListener;
import net.ion.radon.client.websocket.WebSocketListener;
import net.ion.radon.client.websocket.WebSocketUpgradeHandler;
import net.ion.radon.client.websocket.netty.NettyTextMessageTest;
...
public abstract class CloseCodeReasonMessageTest extends TextMessageTest {
	...
	public final static class Listener implements WebSocketListener, WebSocketCloseCodeReasonListener {
		...
		// @Override
		public void onOpen(net.ion.radon.client.websocket.WebSocket websocket) {
		}

		// @Override
		public void onClose(net.ion.radon.client.websocket.WebSocket websocket) {
		}
