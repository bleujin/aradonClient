...
import net.ion.radon.client.util.AsyncHttpProviderUtils;
...
public abstract class RemoteSiteTest extends AbstractBasicTest {
	...
	public void evilCoookieTest() throws Throwable {
		...
		builder2.addCookie(new net.ion.radon.client.Cookie(".google.com", "evilcookie", "test", "/", 10, false));
		net.ion.radon.client.Request request2 = builder2.build();
