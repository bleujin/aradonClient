...
import net.ion.radon.client.ListenableFuture;
...
/**
 * Test for multithreaded url fetcher calls that use two separate sets of ssl certificates. This then tests that the certificate settings do not clash (override each other), resulting in the peer not authenticated exception
 * 
 * @author dominict
 */
public abstract class RedirectConnectionUsageTest extends AbstractBasicTest {
	...
	public void testGetRedirectFinalUrl() {
		...
		try {
			...
			net.ion.radon.client.Request r = builder.build();
